...
const selectinstalledDatatypeTransformers = (state: ExtensionCatalog) =>
  state.installedDatatypeTransformers;
...
export function MessagePipelineProvider({
  ...
  const installedDatatypeTransformers = useExtensionCatalog(selectinstalledDatatypeTransformers);

  useEffect(() => {
    store.getState().dispatch({
      type: "set-message-transformers",
      datatypeTransformers: installedDatatypeTransformers,
    });
  }, [installedDatatypeTransformers, store]);
